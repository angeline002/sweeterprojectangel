...
MONGODB_CONNECTION_STRING = 'mongodb+srv://angeline:mymongodb@cluster0.pjljjdt.mongodb.net/?retryWrites=true&w=majority'

client = MongoClient(MONGODB_CONNECTION_STRING)

db = client.dbsparta_week_plus4
...
def home():
    ...
    try:
        ...
        msg = 'there was a problem while logging you in!'
        return redirect(url_for('login', msg=msg))
...
def sign_in():
    ...
    if result:
        ...
        return jsonify(
            {
                "result": "fail",
                "msg": "could not find a user with that id/password combination!",
            }
        )
